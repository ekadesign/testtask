...
<script>
import SearchFilter from '@/pages/admin/tenders/search/filter'
import SearchListView from '@/pages/admin/tenders/search/listView'
import { getTendersList } from '@/configs/api'
