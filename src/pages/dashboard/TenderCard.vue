<template>
  <div>
    <v-card v-if="!cardActive" :card="card" @click="handleCardClick">
      ...
      <div class="d-flex flex-row justify-space-between">
        ...
        <div class="text-right">
          ...
          <span class="pt-2 pr-2">{{ card.max_price }} ₽</span>
        </div>
      ...
      <div class="d-flex flex-row justify-space-between">
        <div class="d-flex flex-row">
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title>{{ card.region.name }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item>
            <v-list-item-content>
          ...
          <v-list-item>
            <v-list-item-content>
              ...
              <v-list-item-title >{{ card.end_at | formatDate('l') }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </div>
