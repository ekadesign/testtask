<template>
  <div class="d-flex flex-column flex-grow-1">
    ...
    <v-card class="my-4">
      ...
      <v-card-text>
        <v-col><p><strong>ИНН:</strong> {{ mainOrganization.inn }}</p></v-col>
        <v-col><p><strong>Создана:</strong> {{ mainOrganization.created_at | formatDate('lll') }}</p></v-col>
      </v-card-text>
    </v-card>
    ...
    <v-card>
      ...
      >
        ...
        <template v-slot:item.action="{ }">
          <div class="actions">
            <v-btn icon><!--//@TODO add team edit modal-->
